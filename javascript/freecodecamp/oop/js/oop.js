class TodoList {
  ...
  constructor(element){
      ...
      this.boundFindMatchingTasks = this.findMatchingTasks.bind(this);
  ...
  setCompletedStatus( index, completed=true ){
    ...
    findMatchingTasks( searchText ){
      ...
      let olParent     = document.querySelector('#list');
     
     
     itemFilter.addEventListener('input', (e , index)=>{
     
         console.log(e.target.value)
         console.log(searchText.value)
     
         for (let name of olParent.children) {
             let list  = name.textContent.trim() ;
             
          //  //  if(list.indexOf(e.target.value) != -1){
          //        console.log(list.indexOf(e.target.value))
...
todoList.findMatchingTasks(todoList.itemFilter)
});
